...
if (!this.submenu && !$.data(_3aa, "menu").options.manualHide) {
_3a9(_3aa);
...
//20140731 陆村 修改 拖拽线不明显修正，此处保留原代码
//20140919 陆村 修改 拖拽线不明显修正产生问题，恢复原代码，此处保留修正代码
/*_530.each(function () {
    var cell = $(this);
    var td = cell.parent();
    td.resizable({
        edge:6,
        handles: _538,
        disabled: (cell.attr("resizable") ? cell.attr("resizable") == "false" : false),
        minWidth: 25,
        ...
        onStopResize: function (e) {
            _52f.css("cursor", "");
            cell.css("height", "");
            cell._outerWidth($(this)._outerWidth());
            var _539 = cell.parent().attr("field");
            var col = _52a(_52c, _539);
            col.width = cell._outerWidth();
            ...
            _52d.proxy.remove();
            _52d.proxy = null;
            if (cell.parents("div:first.datagrid-header").parent().hasClass("datagrid-view1")) {
                _4ea(_52c);
            }
            _543(_52c);
...
//$(_68a).html(_68e.join(""));20170729 陆村 修改 jquery.html()改进效率
...
$(_694)[0].innerHTML = _697.join("");
    //$(_694).html(_697.join(""));20170729 陆村 修改 jquery.html()改进效率
...
$.fn.combo.defaults=$.extend({},$.fn.validatebox.defaults,{width:"auto",height:22,multiple:false,selectOnNavigation:true,separator:",",editable:true,disabled:false,readonly:false,hasDownArrow:true,value:"",delay:200,deltaX:19,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
